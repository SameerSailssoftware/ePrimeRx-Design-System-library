...
function ajax(a, b, c, d) {
  ...
  u.prototype = {
      ...
      return this.nodes.reduce(function(c, d, e) {
          var f;
          return a ? (f = a.call(b, d, e), f || (f = !1), "string" == typeof f && (f = u(f)), f instanceof u && (f = f.nodes)) : f = d.innerHTML, c.concat(f !== !1 ? f : [])
      }, [])
      ...
      return "object" == typeof a ? this.each(function(b) {
          for (var d in a) b.setAttribute(c + d, a[d])
      }) : this.length ? this.first().getAttribute(c + a) : ""
      ...
      return this.map(function(a, b) {
          var c = a.cloneNode(!0),
              d = this.getAll(c);
          return this.getAll(a).each(function(a, b) {
      ...
      if (a._e)
          for (var c in a._e) a._e[c].forEach(function(a) {
              u(b).on(c, a)
          })
      ...
      return this.map(function(b) {
          do
              if (u(b).is(a)) return b; while ((b = b.parentNode) && b !== document)
      })
      ...
      var b = function(b) {
          return b.matches = b.matches || b.msMatchesSelector || b.webkitMatchesSelector, b.matches(a || "*")
      };
      return "function" == typeof a && (b = a), a instanceof u && (b = function(b) {
      ...
      return /^\s*<t(h|r|d)/.test(a) ? u(document.createElement("table")).html(a).children().nodes : /^\s*</.test(a) ? u(document.createElement("div")).html(a).children().nodes : document.createTextNode(a)
      ...
      if ("string" == typeof b) {
          ...
          b = function(a) {
              var b = arguments;
              u(a.currentTarget).find(d).each(function(d) {
      ...
      if (a = a.replace(/^\s*/, "").replace(/\s*$/, ""), b) return this.select.byCss(a, b);
      ...
      var a = this;
      return this.slice(this.first().elements).reduce(function(b, c) {
